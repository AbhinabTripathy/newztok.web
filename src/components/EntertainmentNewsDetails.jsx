...
const EntertainmentNewsDetails = () => {
  ...
  const handleShareClick = () => {
    try {
      // Get the title
      const title = newsData?.title || 'Entertainment NewzTok Article';
      
      // Use NewzTok logo instead of article media
      const newztokLogo = 'https://api.newztok.in/uploads/newztok-logo.png'; // Update this with the actual logo URL
      ...
      const contentText = newsData?.content 
        ...
        : 'Check out this entertainment article from NewzTok!';
