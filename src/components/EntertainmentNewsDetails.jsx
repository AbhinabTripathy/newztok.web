...
const EntertainmentNewsDetails = () => {
  ...
  const handleShareClick = () => {
    ...
    if (navigator.share) {
      navigator.share({
        title: newsData?.title || 'Entertainment NewzTok Article',
  ...
  const getMediaUrl = (item) => {
    ...
    return 'https://via.placeholder.com/800x400?text=Entertainment+News+Image';
  };
          ...
          <Box sx={{ width: '100%', mb: 3, borderRadius: 2, overflow: 'hidden', position: 'relative' }}>
            <Box 
              ...
              onError={(e) => {
                ...
                e.target.src = 'https://via.placeholder.com/800x400?text=Entertainment+News+Image';
              }}
            />
            {isYoutubeVideo && (
              <Box
