...
const InternationalNewsDetails = () => {
  ...
  useEffect(() => {
    if (newsData && window.setDynamicMetaTags) {
      ...
      const description = newsData.content
        ...
        : 'Check out this international news article from NewzTok!';
      ...
      window.setDynamicMetaTags(
        newsData.title || 'NewzTok International News Article',
        description,
        imageUrl
      );
    }
  ...
  const handleLikeToggle = async (event) => {
    console.log('🔥 INTERNATIONAL LIKE BUTTON CLICKED - NO AUTH REQUIRED');
  ...
  const processContentWithAdditionalImages = (content, additionalImages) => {
    ...
    console.log("Processing international content with additional images:", {
    ...
    console.log("Processed international content length:", processedContent.length, "Images inserted:", imageIndex);
    return processedContent;
  };
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
            ...
            {mediaUrl.type === 'video' ? (
              ...
              <Box 
                ...
                onError={(e) => {
                  ...
                  e.target.src = 'https://placehold.co/800x400/000000/FFFFFF/png?text=International+News+Image';
                }}
              />
            )}
          </Box>
        ...
        <Box sx={{ py: 2, display: 'flex', alignItems: 'center', gap: 4, borderBottom: '1px solid #eee', mb: 3 }}>
          <Box 
            ...
            onClick={(e) => {
              console.log('🔥 INTERNATIONAL LIKE BOX CLICKED');
              e.preventDefault();
              e.stopPropagation();
              handleLikeToggle(e);
            }}
          >
            <IconButton 
              ...
              size="small"
              onClick={(e) => {
                console.log('🔥 INTERNATIONAL LIKE ICON CLICKED');
                e.preventDefault();
                e.stopPropagation();
                handleLikeToggle(e);
              }}
