...
const NationalNewsDetails = () => {
  ...
  const handleShareClick = () => {
    ...
    if (navigator.share) {
      navigator.share({
        title: newsData?.title || 'National NewzTok Article',
  ...
  const getMediaUrl = (item) => {
    ...
    return 'https://via.placeholder.com/800x400?text=National+News+Image';
  };
          ...
          <Box sx={{ width: '100%', mb: 3, borderRadius: 2, overflow: 'hidden', position: 'relative' }}>
            <Box 
              ...
              onError={(e) => {
                ...
                e.target.src = 'https://via.placeholder.com/800x400?text=National+News+Image';
              }}
            />
            {isYoutubeVideo && (
              <Box
