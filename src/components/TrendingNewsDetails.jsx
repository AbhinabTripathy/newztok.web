...
const TrendingNewsDetails = () => {
  ...
  const handleLikeToggle = async (event) => {
    console.log('🔥 TRENDING LIKE BUTTON CLICKED - NO AUTH REQUIRED');
  ...
  const processContentWithAdditionalImages = (content, additionalImages) => {
    ...
    console.log("Processing trending content with additional images:", {
    ...
    console.log("Processed trending content length:", processedContent.length, "Images inserted:", imageIndex);
    return processedContent;
  };
